 ...
 * @Last Modified time: 2018-06-16 00:16:56
 */

#include "pfLmpDrv.h"

/* gsf curve  [111](110); [111](211); serial version */

void pfHome::pfLMPdrv::calGSFUrlx() {
  ...
  for (int it : gsfpnts) {
    ...
    sprintf(cmds[i++], "variable  xdis equal  %f*${wx}", it * dlt);
