 ...
 * @Last Modified time: 2018-02-19 17:31:03
 */

#include "pfLmpDrv.h"
#define APPROX 0.90

void pfHome::pfLMPdrv::calSurfaceNorelax() {
  ...
  areaS100 = lx * ly;
  exprs["suf100"] =
      APPROX * 0.5 * (eS100 - 0.5 * eB100) / areaS100 * EV_A2toJ_M2;
  ...
  areaS110 = lx * ly;
  exprs["suf110"] = APPROX * 0.5 * (eS110 - eB110) / areaS110 * EV_A2toJ_M2;
  ...
  ly = lammps_get_thermo(lmp, LY);
  areaS111 = lx * ly;
  exprs["suf111"] = APPROX * 0.5 * (eS111 - eB111) / areaS111 * EV_A2toJ_M2;
